...
## Clock-style time freeze effect displayed over stunned enemies
## Shows spinning clock hands and pulsing rings
...
func _draw_clock_hands() -> void:
	...
	# Second hand (very fast rotation)
...
func _draw_markers(pulse: float) -> void:
	# Draw the 4 main hour markers (12, 3, 6, 9 o'clock)
