...
func _apply_damage() -> void:
	...
	for area in overlapping_areas:
		...
		if area.is_in_group("enemies"):
			continue
		# Skip player characters if this fire is friendly (created by player)
		if is_friendly and (area.is_in_group("player") or area.is_in_group("characters")):
			continue
	...
	for body in overlapping_bodies:
		...
		if body.is_in_group("enemies"):
			continue
		# Skip player characters if this fire is friendly (created by player)
		if is_friendly and (body.is_in_group("player") or body.is_in_group("characters")):
			continue
		# Check if it has a damage method
