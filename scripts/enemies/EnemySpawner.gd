...
func _create_enrage_explosion(center: Vector2, is_super_boss: bool) -> void:
	...
	explosion.set_script(preload("res://scripts/enemies/effects/visuals/EnrageExplosionVisual.gd"))
	if is_super_boss:
		explosion.set("ring_base_color", Color(0.8, 0.0, 0.2))
		explosion.set("core_base_color", Color(1.0, 0.2, 0.4))
